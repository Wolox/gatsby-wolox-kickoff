    ...
    <section className={styles.productFeatures}>
      ...
      <div className={styles.coreFeatures}>
        <div className={styles.coreFeature1}>
          <div className={styles.coreFeature1Image}>
            <svg
              className={styles.backgroundFeature1}
              viewBox="0 0 200 200"
        ...
        <div className={styles.coreFeature3}>
          <div className={styles.coreFeature1Image}>
            ...
            <svg className={styles.iconWrench} viewBox="0 0 700 700" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={styles.coreFeature2}>
          <div className={styles.coreFeature1Image}>
            ...
            <svg className={styles.iconPaint} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
